...
export const TRUCK_ROUTES: TruckRoute[] = [
  ...
  },
  {
    ...
    status: 'completada',
    stops: [
      { binId: 'b-stop-1', lat: 28.4640, lng: -16.2490, address: 'C/ La Salud, 3', containerType: 'mixto', visitedAt: '06:10', durationMin: 3 },
      { binId: 'b-stop-2', lat: 28.4620, lng: -16.2470, address: 'Av. de Los Majuelos, 15', containerType: 'mixto', visitedAt: '06:25', durationMin: 4 },
      ...
      { binId: 'b-stop-6', lat: 28.4548, lng: -16.2400, address: 'Cabo Llanos, bloque 5', containerType: 'mixto', visitedAt: '07:30', durationMin: 4 },
    ],
  },
  {
    id: 'ruta-c',
    ...
    status: 'planificada',
    stops: [
      { binId: 'c-stop-1', lat: 28.4700, lng: -16.2460, address: 'C/ Valentín Sanz, 11', containerType: 'mixto', visitedAt: '10:05', durationMin: 4 },
      { binId: 'c-stop-2', lat: 28.4720, lng: -16.2440, address: 'Av. de Benito Pérez Armas, 33', containerType: 'mixto', visitedAt: '10:22', durationMin: 3 },
